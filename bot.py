...
@bot.tree.command(name="restorechannel", description="Restore a recently deleted channel, VC, forum, category, or stage (Manage Channels/Staff/Manager only)")
@app_commands.describe(number="Which deleted channel to restore — 1 is the most recently deleted. See /deletedchannels for the list.")
...
@bot.tree.command(name="removesubs", description="Free, self-hosted AI removal of burned-in subtitles/text from a video — upload a file or paste a link")
@app_commands.describe(
