...
RATE_EDIT_PROMPT = (
    ...
    "2. Your best guess at what software was likely used (e.g. CapCut, Alight Motion, Premiere, "
    "After Effects) based on visual style — say clearly if you're not sure.\n"
    "3. 2-3 concrete, specific tips to improve.\n"
    "Be honest, not falsely encouraging — but stay constructive. Keep it under 150 words. "
...
async def _run_rate_edit(interaction: discord.Interaction, source_message: discord.Message):
    ...
    try:
        ...
        embed.set_footer(text="AI-generated feedback based on a few sampled frames — take it as a starting point, not gospel.")
        await interaction.followup.send(embed=embed)
