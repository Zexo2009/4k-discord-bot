...
RATE_EDIT_PROMPT = (
    ...
    "genuine merit, not on hitting a preset distribution. Don't inflate weak work with empty "
    "praise, but just as importantly, don't deflate a genuinely strong edit just to seem strict — "
    "if it's excellent, say so and score it that way. Based only on what's visible in these "
    "frames, write a short, direct review covering:\n"
    "1. An overall score out of 10 for visual polish (grading, sync/impact framing, composition). "
    "Score what you actually see: roughly 8-10 for genuinely strong, well-executed work; 6-7 for "
    "solid work with minor issues; 4-5 for average work with real, noticeable weaknesses; 1-3 for "
    "rough or amateurish work. Be honest in both directions — accurate, not artificially harsh.\n"
    "2. A skill tier that best fits this edit — pick exactly one of: Beginner, Intermediate, "
    "Advanced, Pro. Label it clearly as 'Skill tier: X'. Base this only on the technique actually "
    "visible in the frames, not on an assumption that most submissions are beginner-level.\n"
