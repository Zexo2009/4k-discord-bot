...
async def slash_previewvotes(interaction: discord.Interaction):
    ...
    try:
        entries = await asyncio.wait_for(collect_pending_entries(interaction.guild), timeout=60)
    except asyncio.TimeoutError:
        print("⚠️ /previewvotes: collect_pending_entries took over 60s — aborting and telling the user.")
