...
def build_help_embed():
    ...
    embed.add_field(
        ...
        value=(
            ...
            "`badwords add/remove/list <word>` — Manage your risk-word list *(Manager/Staff only)*\n"
            "`purgebadwords #channel|all` — Purge every risk-word match, one channel or ALL of them *(Manager/Staff only)*"
        ),
        inline=False,
    )
    embed.add_field(
